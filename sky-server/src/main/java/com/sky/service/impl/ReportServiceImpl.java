...
public class ReportServiceImpl implements ReportService {
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        ...
        List<Integer> salesList = salesTop10.stream().map(GoodsSalesDTO::getNumber).toList();
        String salesCountList = StringUtils.join(salesList, ",");

        // 封装数据
        return SalesTop10ReportVO.builder()
                .nameList(nameList)
                .numberList(salesCountList)
                .build();
    }
    ...
    public void exportBusinessData(HttpServletResponse response) {
        ...
        // 写入模板文件
        var inputStream = this.getClass().getClassLoader().getResourceAsStream("template/运营数据报表模板.xlsx");
        try {
            ...
            for(int i = 0; i < 30; i++){
                ...
                var businessData = workspaceService.getBusinessData(
